...
public final class Http {
	public static void main(String[] args) {
		    try {
			    	...
			    	params.add(new BasicNameValuePair("code", "genres"));
			    	params.add(new BasicNameValuePair("unPaged", "true"));
			    	System.out.println(Http.get("http://localhost/product/tag/show.action", params)); 
		    } catch (Exception e) {
  ...
  public static String get(String uri, List<NameValuePair> params) throws Exception {
    String url = uri;
    if (params != null) {
  ...
  public static String get(String uri, Header... headers) throws Exception {
  ...
  public static String responseToString(HttpResponse response) throws Exception {
    ...
    if (entity != null) {
      ...
      try {
        result = IOUtils.toString(entity.getContent(), charset==null?null:charset.toString());
      } catch (Exception e) {
        throw new Exception(e);
      }
      return result;
